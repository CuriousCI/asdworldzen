...
<!--     <SpeedDialButton name="Condividi"> -->
<!--         <svg -->
<!--             aria-hidden="true" -->
<!--             class="w-6 h-6" -->
<!--             fill="currentColor" -->
...
<!--         > -->
<!--     </SpeedDialButton> -->
<!--     <SpeedDialButton name="Tema"> -->
<!--         <DarkMode /> -->
<!--     </SpeedDialButton> -->
<!-- </SpeedDial> -->
<!-- <div class="prose"> -->
<!--     <h1 id="corsi">Corsi</h1> -->
<!-- </div> -->
...
<!--     </video> -->
<!--     <div -->
<!--         class="absolute top-0 w-full h-full grid place-items-center bg-gradient-to-b from-black/60 to-black/80" -->
<!--     > -->
<!--         <div class="p-10"> -->
