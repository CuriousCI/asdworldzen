import { S as SvelteComponent, i as init, s as safe_not_equal, k as element, a as space, q as text, l as claim_element, m as children, h as detach, c as claim_space, r as claim_text, J as src_url_equal, n as attr, p as set_style, b as insert_hydration, H as append_hydration, C as noop } from "../../chunks/index-4506c01f.js";
...
function create_fragment(ctx) {
  ...
  return {
    ...
    l(nodes) {
      main0 = claim_element(nodes, "MAIN", { class: true });
      var main0_nodes = children(main0);
      video = claim_element(main0_nodes, "VIDEO", { id: true, class: true });
      var video_nodes = children(video);
      source = claim_element(video_nodes, "SOURCE", { src: true, type: true });
      video_nodes.forEach(detach);
      t0 = claim_space(main0_nodes);
      div3 = claim_element(main0_nodes, "DIV", { class: true });
      ...
      main0_nodes.forEach(detach);
      t7 = claim_space(nodes);
      main1 = claim_element(nodes, "MAIN", { class: true });
      var main1_nodes = children(main1);
      div4 = claim_element(main1_nodes, "DIV", { class: true });
      var div4_nodes = children(div4);
      img5 = claim_element(div4_nodes, "IMG", { src: true, alt: true, class: true });
      t8 = claim_space(div4_nodes);
      img6 = claim_element(div4_nodes, "IMG", { src: true, alt: true, class: true });
      t9 = claim_space(div4_nodes);
      img7 = claim_element(div4_nodes, "IMG", { src: true, alt: true, class: true });
      div4_nodes.forEach(detach);
      main1_nodes.forEach(detach);
      t10 = claim_space(nodes);
      main2 = claim_element(nodes, "MAIN", { class: true });
      var main2_nodes = children(main2);
      div5 = claim_element(main2_nodes, "DIV", { class: true });
    ...
    m(target, anchor) {
      insert_hydration(target, main0, anchor);
      append_hydration(main0, video);
      append_hydration(video, source);
      append_hydration(main0, t0);
      append_hydration(main0, div3);
      ...
      append_hydration(div4, img6);
      append_hydration(div4, t9);
      append_hydration(div4, img7);
      insert_hydration(target, t10, anchor);
      insert_hydration(target, main2, anchor);
      append_hydration(main2, div5);
      append_hydration(div5, iframe0);
      append_hydration(div5, t11);
      append_hydration(div5, iframe1);
    },
    p: noop,
    i: noop,
    o: noop,
